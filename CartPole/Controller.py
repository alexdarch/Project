        ...
        for i in range(self.args.policyIters):
            ...
            if not self.skipFirstSelfPlay or i > 1:
                ...
                for eps in range(1, self.args.trainEps+1):
                    ...
                    example_episode = self.execute_episode()  # ought to return both the value and predicted value + MCTS-action and Policy Action
                    policy_examples.extend(example_episode)
                    policy_examples_to_csv.append(example_episode)
