...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{nnetloss0.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{nnetloss1.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{nnetloss2.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{nnetloss10.PNG}
